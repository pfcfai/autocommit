...
for i in range(17):
    ...
    sql='select Date,timestamp,Close from {} order by timestamp desc limit 2520;'.format(tb[i])
...
import json
with open('/home/spark/autocommit/EXCEL_AutoUpdate/corr_10yr.json', 'w') as json_file:
    json.dump(mylist, json_file)
       

print('update every 1st day of the month')
