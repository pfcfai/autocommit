...
# 設定契約、契約名稱、契約規格 (原本的OI對應表達錯誤 不可以用S&P的OI表達 微型S&P的OI)
tablenames=['es','nq','ym','ad','bp','cd','ec','jy','sf','zc','zs','zw','gc','si','hg','cl','ty','us']
contractdict={'es':50,'nq':20,'ym':5,'ad':100000,'bp':100000*0.625,'cd':10000*10,'ec':100000*1.25,'jy':1*1.25,'sf':10000*12.5,'zc':50,'zs':50,'zw':50,'gc':100,'si':5000,'hg':25000,'cl':1000,'ty':1000,'us':1000}
namesdict={'es':'小型S&P','nq':'小型NASDAQ','ym':'小型道瓊','ad':'澳幣','bp':'英鎊','cd':'加幣','ec':'歐元','jy':'日圓','sf':'瑞士法郎','zc':'玉米','zs':'黃豆','zw':'小麥','gc':'黃金','si':'白銀','hg':'銅','cl':'輕原油','ty':'T-Bond','us':'T-Note'}
...
# 小型指數 = 10*微型指數 / 貨幣 = 10個微型貨幣 / 穀物 = 5個小穀物 / 黃金 = 10個微型黃金 / *白銀 = 5個微型白銀 
